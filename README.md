...
**M.Tech CSE Student | Full Stack Developer**

- 🎓 **Education:** M.Tech, Computer Science & Engineering — Lovely Professional University, Phagwara, Punjab (Aug 2025 – Present, CGPA: 9.5)
- 🧰 **Languages:** C, C++, Python, Ruby, JavaScript, HTML, CSS
- ⚙️ **Frameworks:** ReactJS, Next.js, Tailwind CSS, Bootstrap, Ruby on Rails
- 🤖 **AI & Backend:** Generative AI, RAG Fundamentals, FastAPI, MySQL, PostgreSQL, Vector Databases
- 🛠️ **Tools:** Git, GitHub, VS Code, PyCharm, XAMPP, Docker
- 🚀 **Projects:** AI-Based Finance Platform, Brain Tumor Segmentation (PSO-Optimized U-Net), Hospital Management System
- 📌 **Status:** Learning & Building
- 🤝 **Open to:** Collaboration, Internships, Full Stack + AI Projects
